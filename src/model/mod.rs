...
impl CanvasItem {
    pub fn svg_compatibility(&self) -> SvgCompatibility {
        match self {
            ...
            CanvasItem::ImportedImage(_) => SvgCompatibility::Incompatible(
                IncompatibleExportReason::RasterContent,
            ),
            CanvasItem::ImportedPdfPage(_) => SvgCompatibility::Incompatible(
                IncompatibleExportReason::ImportedPdfPage,
            ),
        }
    }
}
